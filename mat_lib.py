...
# --- 3. ПАТТЕРНЫ ПОЛИТИКИ (Расширенный список) ---
POLITICS_PATTERNS = [
    # Персоны и страны
    ...
    r'выбор', r'голосован', r'депутат', r'правительств', r'мид',
    r'взрыв', r'теракт', r'атак', r'бпла', r'дрон', r'ракет',
    
    # Оскорбления и сленг (Добавлено)
    r'русн[яю]', r'русни',       # русня
    r'хох[о]?л', r'хохлы',       # хохлы
    r'москал', r'кацап',         # москаль, кацап
    r'ватник', r'укроп', r'бандер', r'нацист', r'фашист', r'рашк',
    r'z', r'v'
]
